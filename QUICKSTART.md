...
打开 https://github.com/362507574-sys/DFMH-PinPaiGuan ，选择 `Code → Download ZIP`，解压到类似 `C:\DFMH\DFMH-PinPaiGuan` 的短路径。熟悉 Git 的用户也可以执行：

```powershell
git clone https://github.com/362507574-sys/DFMH-PinPaiGuan.git C:\DFMH\DFMH-PinPaiGuan
```
...
- `organizations/ai-brand-officer/AGENTS.md`
- `organizations/ai-brand-officer/skills/brand-positioning/SKILL.md`
- `organizations/ai-brand-officer/skills/brand-visual/SKILL.md`
- `organizations/ai-brand-officer/skills/brand-communication/SKILL.md`

### 4. 更新到最新版本

保留仓库外的客户资料和项目成果，然后对 Codex 说：

> 请从 https://github.com/362507574-sys/DFMH-PinPaiGuan 更新当前组织包到最新 main 版本，保留仓库外的业务资料，完成后重新运行 npm test 并汇报版本与三个技能。
